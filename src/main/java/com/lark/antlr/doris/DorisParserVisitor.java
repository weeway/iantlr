...
public interface DorisParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code showWaringErrorCount}
	 * labeled alternative in {@link DorisParser#unsupportedShowStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitShowWaringErrorCount(DorisParser.ShowWaringErrorCountContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code showAnalyzeFromJobId}
	 * labeled alternative in {@link DorisParser#unsupportedStatsStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitShowAnalyzeFromJobId(DorisParser.ShowAnalyzeFromJobIdContext ctx);
	/**
	 * Visit a parse tree produced by the {@code showAutoAnalyzeJobs}
	 * labeled alternative in {@link DorisParser#unsupportedStatsStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitShowAutoAnalyzeJobs(DorisParser.ShowAutoAnalyzeJobsContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link DorisParser#functionArgument}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionArgument(DorisParser.FunctionArgumentContext ctx);
	/**
